    ...
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-slate-700">Admin Overview</p>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-sm text-slate-700">Programs currently visible in the public catalog.</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-sm text-slate-700">Prospective learners in active registration and onboarding.</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2 text-sm text-slate-700">Skill tracks and trade programs available for enrollment.</p>
          </CardContent>
        </Card>
      </div>
    </div>
