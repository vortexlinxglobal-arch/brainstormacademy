...
export default function ContactPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!name.trim() || !email.trim() || !subject.trim()) {
      setStatus({
        type: "error",
        text: "Please provide your name, email, and what you are interested in.",
      });
      return;
    }
    ...
    try {
      ...
      setStatus({
        type: "success",
        text: "Thank you! Your inquiry has been sent. Our admissions team will be in touch soon.",
      });
      setName("");
      setEmail("");
      setPhone("");
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
                Let's start a conversation about your next skill, certification,
                or career move.
              </h1>
              <p className="max-w-2xl text-base leading-8 text-slate-200 sm:text-lg sm:leading-9">
                Whether you are ready to enroll, need support with admissions,
                or want to partner with Brainstorm Skills, our team is here to
                provide fast guidance and helpful next steps.
              </p>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-slate-900/85 p-8 shadow-2xl shadow-black/20 backdrop-blur-xl sm:p-10">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-4 h-48 w-full overflow-hidden rounded-2xl">
                    <iframe
                      title="Brainstorm Academy - Hayin Danmani"
                      src="https://www.google.com/maps?q=No.+22+Ni'ma+Road,+Hayin+Danmani,+Kaduna,+Nigeria&output=embed"
        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-8 rounded-3xl border border-slate-200/10 bg-white p-8 shadow-lg shadow-slate-900/5">
            ...
            <p className="text-base leading-8 text-slate-700">
              ...
              Include your course interest, preferred start date, and any
              questions you have about admissions or financing.
            </p>
          ...
          <div className="space-y-8">
            <div className="rounded-3xl border border-slate-200/10 bg-white p-8 shadow-lg shadow-slate-900/5">
              ...
              <div className="mt-6 space-y-4 text-sm leading-7 text-slate-700">
                ...
                <div>
                  ...
                  <p>
                    Get guidance through admissions, registration, and payments.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-slate-900">Partnerships</p>
                  <p>
                    Discuss collaboration opportunities with our training
                    center.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Ask about placement services, internships, and graduate
                    support.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200/10 bg-white p-8 shadow-lg shadow-slate-900/5">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-700">
                You can also reach us by phone, email, or visit our campus in
                Kaduna for a guided tour and registration support.
              </p>
              <div className="mt-6 space-y-3 text-sm text-slate-700">
                <p className="font-semibold text-slate-900">Phone</p>
                <a
                  href="tel:+2349018837909"
                  className="text-[#1a6b53] hover:text-[#134c35]"
                >
                  +234 901 883 7909
                </a>
              </div>
