...
const InstructorDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      setLoading(true)
      // For instructors, we'll use staff dashboard data since instructors are a type of staff
      const [dashboard, coursesData, notificationsData] = await Promise.all([
        apiClient.getStaffDashboard(),
        apiClient.getTrades(), // Get all trades/courses for instructors
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {dashboardData?.courses_teaching || 0}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-600">Avg. Student Rating</p>
                    <p className="text-2xl font-semibold text-gray-900">
                      {dashboardData?.average_rating || 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow">
              ...
              <div className="p-6">
                <div className="space-y-3">
                  ...
                  <Link
                    to="/dashboard/instructor/grades"
                    className="block w-full px-4 py-2 text-sm font-medium text-center text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50"
                  >
                    Manage Grades
                  </Link>
              ...
              <div className="p-6">
                <div className="space-y-3">
                  <div className="text-center py-4">
                    <p className="text-sm text-gray-500">No scheduled classes today</p>
                  </div>
                  <div className="border-t pt-3">
                    <p className="text-xs text-gray-500 mb-2">Upcoming this week:</p>
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Mon: Web Development</span>
                        <span className="text-gray-400">2:00 PM</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Wed: Database Design</span>
                        <span className="text-gray-400">10:00 AM</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Fri: Project Work</span>
                        <span className="text-gray-400">1:00 PM</span>
                      </div>
                    </div>
                  </div>
                </div>
