...
const variantStyles = {
  ...
  outline: 'border border-slate-300 text-slate-900 hover:bg-slate-50 active:bg-slate-100 focus:ring-[#0A6C3F]/40',
  ghost: 'text-slate-900 hover:bg-slate-100 active:bg-slate-200 focus:ring-[#0A6C3F]/30',
  brand: 'bg-[#0A6C3F] text-white hover:bg-[#0f6f44] active:bg-[#084d2e] focus:ring-[#0A6C3F]/40',
