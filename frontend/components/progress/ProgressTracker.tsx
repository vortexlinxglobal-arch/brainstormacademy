      ...
      <CardHeader className="px-6 pt-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Visualize your overall completion and course progress at a glance.</p>
          </div>
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">{course.completedModules}/{course.moduleCount} modules complete</p>
                    </div>
